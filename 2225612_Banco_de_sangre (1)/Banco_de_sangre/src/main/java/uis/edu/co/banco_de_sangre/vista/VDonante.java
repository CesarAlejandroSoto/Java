...
public class VDonante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBuscarPorGrupoSanguineo.setBackground(new java.awt.Color(102, 102, 255));
        ...
        btnAlarmaDonacionesAntiguas.setBackground(new java.awt.Color(102, 102, 255));
    ...
    if (resultadoConsulta != null) {
        ...
        try {
            // Iterar sobre el resultado de la consulta y agregar los datos a la tabla
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        // Obtener el ID del donante a consultar
    ...
    // Consultar la base de datos para obtener la información del donante
    CDonante controlador = new CDonante();
    Donante donante = controlador.consultarDonantePorId(idDonante);
    
    // Cargar el donante consultado en la tabla
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // Obtener el ID del donante a eliminar
    String idDonanteTexto = txtIdDonante.getText();
    ...
    // Confirmar con el usuario antes de eliminar el donante
    ...
    if (confirmacion == JOptionPane.YES_OPTION) {
        // Si el usuario confirma la eliminación, llamar al método eliminarDonante()
        CDonante controlador = new CDonante();
        controlador.eliminarDonante(idDonante);
        
        // Actualizar la tabla después de eliminar el donante
        actualizarTabla();
    }
    }//GEN-LAST:event_btnEliminarActionPerformed
// Método para actualizar la tabla basado en el grupo sanguíneo seleccionado
